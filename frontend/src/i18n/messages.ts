export const messages = {
  'zh-CN': {
    ...
    'relayIntegration.title': 'New API 中继集成',
    'relayIntegration.description': '本地中继配置与运行状态',
    'relayIntegration.refresh': '刷新中继集成状态',
    'relayIntegration.statusTitle': '中继集成状态',
    'relayIntegration.configuration': '配置',
    'relayIntegration.configured': '已配置',
    'relayIntegration.notConfigured': '未配置',
    'relayIntegration.localRuntime': '本地中继运行时',
    'relayIntegration.localRuntimeHint': '仅表示本地运行状态',
    'relayIntegration.relayEnabled': '已启用',
    'relayIntegration.relayDisabled': '已停用',
    'relayIntegration.operationStatus': '运行状态',
    'relayIntegration.operationActive': '可用',
    'relayIntegration.dashboardTitle': '中继摘要',
    'relayIntegration.dashboardDescription': '本地中继资源与价格同步汇总',
    'relayIntegration.dashboardUnavailableTitle': '中继摘要暂不可用',
    'relayIntegration.dashboardUnavailableDescription': '集成状态仍可单独查看。',
    'relayIntegration.channels': '通道',
    'relayIntegration.enabledChannels': '已启用 / 总数',
    'relayIntegration.downstreamInstances': '下游实例',
    'relayIntegration.currentDownstream': '当前已配置',
    'relayIntegration.lastPriceSync': '最后价格同步',
    'relayIntegration.priceSyncResult': '{models} 个模型 / {channels} 个通道',
    'relayIntegration.priceSyncFailures': '价格同步失败',
    'relayIntegration.priceSyncFailureHint': '最近一次同步中的失败通道数',
    'relayIntegration.integrationEnabled': '集成已启用',
    'relayIntegration.integrationDisabled': '集成已停用',
    'relayIntegration.directChannel': '直接通道',
    'relayIntegration.reservedMode': '保留模式: {mode}',
    'relayIntegration.reservedModeStatus': '保留模式已关闭',
    'relayIntegration.configTitle': '配置摘要',
    'relayIntegration.configDescription': '当前本地持久化配置',
    'relayIntegration.instanceId': '实例标识',
    'relayIntegration.routeProfile': '路由策略',
    'relayIntegration.executionMode': '执行模式',
    'relayIntegration.integrationState': '集成状态',
    'relayIntegration.capabilityVersion': '能力版本',
    'relayIntegration.configRevision': '配置修订',
    'relayIntegration.lastUpdated': '最后更新',
    'relayIntegration.credentialsTitle': '凭据轮换状态',
    'relayIntegration.credentialsDescription': '仅显示版本与过渡状态',
    'relayIntegration.credentialRevision': '凭据修订',
    'relayIntegration.credentialTransition': '过渡状态',
    'relayIntegration.transitionActive': '过渡中',
    'relayIntegration.transitionInactive': '稳定',
    'relayIntegration.transitionExpires': '过渡截止时间',
    'relayIntegration.unavailable': '暂不可用',
    'relayIntegration.errorTitle': '无法读取中继集成状态',
    'relayIntegration.errorDescription': '请稍后刷新后重试。',
    'relayIntegration.relatedTitle': '相关管理视图',
    'relayIntegration.providers': '提供商',
    'relayIntegration.pool': '号池',
    'relayIntegration.routing': '调度策略',
    'relayIntegration.usage': '用量记录',
  },
  'en-US': {
    ...
    'nav.routing': 'Routing',
    'nav.pool': 'Pool',
    'nav.relayIntegration': 'Relay integration',
    ...
    'relayIntegration.title': 'New API relay integration',
    'relayIntegration.description': 'Local relay configuration and runtime status',
    'relayIntegration.refresh': 'Refresh relay integration status',
    'relayIntegration.statusTitle': 'Relay integration status',
    'relayIntegration.configuration': 'Configuration',
    'relayIntegration.configured': 'Configured',
    'relayIntegration.notConfigured': 'Not configured',
    'relayIntegration.localRuntime': 'Local relay runtime',
    'relayIntegration.localRuntimeHint': 'Shows local runtime state only',
    'relayIntegration.relayEnabled': 'Enabled',
    'relayIntegration.relayDisabled': 'Disabled',
    'relayIntegration.operationStatus': 'Operation status',
    'relayIntegration.operationActive': 'Available',
    'relayIntegration.dashboardTitle': 'Relay summary',
    'relayIntegration.dashboardDescription': 'Local relay resource and price-sync summary',
    'relayIntegration.dashboardUnavailableTitle': 'Relay summary is unavailable',
    'relayIntegration.dashboardUnavailableDescription': 'Integration status remains available separately.',
    'relayIntegration.channels': 'Channels',
    'relayIntegration.enabledChannels': 'Enabled / total',
    'relayIntegration.downstreamInstances': 'Downstream instances',
    'relayIntegration.currentDownstream': 'Currently configured',
    'relayIntegration.lastPriceSync': 'Last price sync',
    'relayIntegration.priceSyncResult': '{models} models / {channels} channels',
    'relayIntegration.priceSyncFailures': 'Price sync failures',
    'relayIntegration.priceSyncFailureHint': 'Failed channels in the latest sync',
    'relayIntegration.integrationEnabled': 'Integration enabled',
    'relayIntegration.integrationDisabled': 'Integration disabled',
    'relayIntegration.directChannel': 'Direct channel',
    'relayIntegration.reservedMode': 'Reserved mode: {mode}',
    'relayIntegration.reservedModeStatus': 'Reserved mode is closed',
    'relayIntegration.configTitle': 'Configuration summary',
    'relayIntegration.configDescription': 'Current local persisted configuration',
    'relayIntegration.instanceId': 'Instance ID',
    'relayIntegration.routeProfile': 'Routing profile',
    'relayIntegration.executionMode': 'Execution mode',
    'relayIntegration.integrationState': 'Integration state',
    'relayIntegration.capabilityVersion': 'Capability version',
    'relayIntegration.configRevision': 'Configuration revision',
    'relayIntegration.lastUpdated': 'Last updated',
    'relayIntegration.credentialsTitle': 'Credential rotation status',
    'relayIntegration.credentialsDescription': 'Shows version and transition state only',
    'relayIntegration.credentialRevision': 'Credential revision',
    'relayIntegration.credentialTransition': 'Transition status',
    'relayIntegration.transitionActive': 'Transition active',
    'relayIntegration.transitionInactive': 'Stable',
    'relayIntegration.transitionExpires': 'Transition expiry',
    'relayIntegration.unavailable': 'Unavailable',
    'relayIntegration.errorTitle': 'Relay integration status is unavailable',
    'relayIntegration.errorDescription': 'Refresh the page and try again.',
    'relayIntegration.relatedTitle': 'Related management views',
    'relayIntegration.providers': 'Providers',
    'relayIntegration.pool': 'Pool',
    'relayIntegration.routing': 'Routing',
    'relayIntegration.usage': 'Usage records',
  },
} as const
