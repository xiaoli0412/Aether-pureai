...
ADD COLUMN profit_status TEXT NOT NULL DEFAULT 'pending'
...
ON relay_event_inbox(instance_id, profit_status, occurred_at)
WHERE event_type = 'usage_settled' AND profit_status = 'pending';
